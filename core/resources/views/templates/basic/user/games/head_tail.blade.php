                ...
                <div class="card border-0 mb-3">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div align="center" class="card-body h-100 middle-el">
                                <div class="alt"></div>
                                <div class="game-details-left">
                                    <div class="game-details-left__body">
                                        <div style="height: 210px;" class="flp">
                                    ...
                                    <form id="game" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <input class="form-control " name="invest" type="text" value="{{ old('invest') }}" placeholder="@lang('Enter amount')">
                                                <span class="input-group-text" id="basic-addon2">
                                                    {{ __($general->cur_text) }}
                                                </span>
                                            </div>
                                            <small class="form-text text-muted text-center">
                                                Minimum : {{ showAmount($game->min_limit) }} {{ __($general->cur_text) }} | Maximum : {{ showAmount($game->max_limit) }} {{ __($general->cur_text) }}
                                                <br> 
                                                <span class="text-warning">Win Amount 
                                        ...
                                        <div class="form-group justify-content-center d-flex mt-1">
                                            <div class="single-select head gmimg">
                                                <img width="100px" src="{{ asset($activeTemplateTrue . '/images/play/head.png') }}"
                                                    alt="game-image">
                                            </div>
                                            <div class="single-select tail gmimg">
                                                <img width="100px" src="{{ asset($activeTemplateTrue . '/images/play/tail.png') }}"
                                                    alt="game-image">
                                            </div>
                                            <input name="choose" type="hidden">
                                        </div>
                                        <div class="mt-3 text-center">
                                            <button class="btn btn-primary w-100 game text-center border-custom" id="flip"
                                                type="submit">Play Now</button>
                        ...
                        <form id="game" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted"><i
                                    ...
                                    : {{ showAmount($game->max_limit) }} {{ __($general->cur_text) }} | <span
                                        class="text--warning">@lang('Win Amount') @if ($game->invest_back == 1)
                                            {{ showAmount($game->win + 100) }}
                                        @else
                                            {{ showAmount($game->win) }}
                                        @endif %</span></small>
