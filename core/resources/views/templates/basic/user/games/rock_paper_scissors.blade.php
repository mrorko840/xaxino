                                    ...
                                    <div class="game-details-left__body">
                                        <div class="sld">
                                            <div class="imgs sld-wrapper position-relative text-center">
                                                <div class="img1">
                                                    <img width="200px" src="{{ asset($activeTemplateTrue . 'images/play/rock.png') }}">
                                                </div>
                                                <div class="img2 op-0">
                                                    <img width="200px" src="{{ asset($activeTemplateTrue . 'images/play/paper.png') }}">
                                                </div>
                                                <div class="img3 op-0">
                                                    <img width="200px" src="{{ asset($activeTemplateTrue . 'images/play/scissors.png') }}">
                                                </div>
                                            </div>
                                            <div style="justify-content: center;" class="result d-none align-items-center text-center">
                                                <div class="">
                                                    <img  width="160px" class="im-1" src="{{ asset($activeTemplateTrue . 'images/play/rock.png') }}">
                                                </div>
                                                <h1 class="opac-0 vs-title">@lang('VS')</h1>
                                                <div class="">
                                                    <img  width="160px" class="im-2 opac-0" src="{{ asset($activeTemplateTrue . 'images/play/paper.png') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form id="game">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted text-center">
                                                @lang('Minimum :') {{ showAmount($game->min_limit) }} {{ __($general->cur_text) }}
                                        ...
                                        <div class="form-group justify-content-center d-flex">
                                            <div class="single-select rock p-0">
                                                <img width="90px" src="{{ asset($activeTemplateTrue . '/images/play/rock.pn') }}g" alt="game-image">
                                            </div>
                                            <div class="single-select paper p-0">
                                                <img width="90px" src="{{ asset($activeTemplateTrue . '/images/play/paper.png') }}" alt="game-image">
                                            </div>
                                            <div class="single-select scissors p-0">
                                                <img width="90px" src="{{ asset($activeTemplateTrue . '/images/play/scissors.png') }}" alt="game-image">
                                            </div>
                                        </div>
                                        <input name="choose" type="hidden">
                                        <div class="mt-1 text-center">
                                            <button class="btn btn-primary border-custom w-100 text-center" id="flip" type="submit">@lang('Play Now')</button>
