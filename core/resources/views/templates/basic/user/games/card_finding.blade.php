                                ...
                                <div class="game-details-right">
                                    <form id="game" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted text-center">@lang('Minimum')
                                        ...
                                        <div class="form-group justify-content-center d-flex">
                                            <div class="single-select red">
                                                <img width="100px" class="red shadow" src="{{ asset($activeTemplateTrue . 'images/play/cards/27.png') }}" alt="">
                                            </div>
                                            <div class="single-select black">
                                                <img width="100px" class="black shadow" src="{{ asset($activeTemplateTrue . 'images/play/cards/40.png') }}" alt="">
                                            </div>
                                        </div>
