                        ...
                        <div class="row align-items-center">
                            ...
                            <div align="center" class="col">
                                <div class="card-body h-100 middle-el p-0">
                                    <div style="height: 350px;" class="game-details-left fly">
                                    ...
                                    <form id="game" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted text-center">
                                                ...
                                                : {{ showAmount($game->max_limit) }} {{ $general->cur_text }}
                                                <br> 
                                        ...
                                        <div align="center" class="form-group justify-content-center d-flex flex-wrap">

                                            <div style="justify-content: center;" class="row">
                                                <div class="single-select pool pool-01">
                                                    <img width="35px" class="gmimg pool-01" src="{{ asset($activeTemplateTrue . 'images/play/pools/01.png') }}" alt="">
                                                </div>
                                                <div class="single-select pool pool-02">
                                                    <img width="35px" class="gmimg pool-02" src="{{ asset($activeTemplateTrue . 'images/play/pools/02.png') }}" alt="">
                                                </div>
                                                <div class="single-select pool pool-03">
                                                    <img width="35px" class="gmimg pool-03" src="{{ asset($activeTemplateTrue . 'images/play/pools/03.png') }}" alt="">
                                                </div>
                                                <div class="single-select pool pool-04">
                                                    <img width="35px" class="gmimg pool-04" src="{{ asset($activeTemplateTrue . 'images/play/pools/04.png') }}" alt="">
                                                </div>
                                                <div class="single-select pool pool-05">
                                                    <img width="35px" class="gmimg pool-05" src="{{ asset($activeTemplateTrue . 'images/play/pools/05.png') }}" alt="">
                                                </div>
                                                <div class="single-select pool pool-06">
                                                    <img width="35px" class="gmimg pool-06" src="{{ asset($activeTemplateTrue . 'images/play/pools/06.png') }}" alt="">
                                                </div>
                                                <div class="single-select pool pool-07">
                                                    <img width="35px" class="gmimg pool-07" src="{{ asset($activeTemplateTrue . 'images/play/pools/07.png') }}" alt="">
                                                </div>
                                                <div class="single-select pool pool-08">
                                                    <img width="35px" class="gmimg pool-08" src="{{ asset($activeTemplateTrue . 'images/play/pools/08.png') }}" alt="">
                                                </div>
                                            </div>
                                        </div>
