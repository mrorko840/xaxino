                                    ...
                                    <form id="game">
                                        ...
                                        <div class="form-group justify-content-center d-flex flex-wrap">
                                            <div class="single-select dice dice1">
                                                <img width="65px" class="gmimg dice1" src="{{ asset($activeTemplateTrue . 'images/play/dice1.png') }}" alt="">
                                            </div>
                                            <div class="single-select dice dice2">
                                                <img width="65px" class="gmimg dice2" src="{{ asset($activeTemplateTrue . 'images/play/dice2.png') }}" alt="">
                                            </div>
                                            <div class="single-select dice dice3">
                                                <img width="65px" class="gmimg dice3" src="{{ asset($activeTemplateTrue . 'images/play/dice3.png') }}" alt="">
                                            </div>
                                            <div class="single-select dice dice4">
                                                <img width="65px" class="gmimg dice4" src="{{ asset($activeTemplateTrue . 'images/play/dice4.png') }}" alt="">
                                            </div>
                                            <div class="single-select dice dice5">
                                                <img width="65px" class="gmimg dice5" src="{{ asset($activeTemplateTrue . 'images/play/dice5.png') }}" alt="">
                                            </div>
                                            <div class="single-select dice dice6">
                                                <img width="65px" class="gmimg dice6" src="{{ asset($activeTemplateTrue . 'images/play/dice6.png') }}" alt="">
                                            </div>
                                        </div>
