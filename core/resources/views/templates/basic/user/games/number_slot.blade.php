                ...
                <div class="card border-0 mb-3">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <div class='machine position-relative mt-5 '>
                                    <div class='slots border-custom'>
                                        <ul class='slot text-white' id="slot1">
                                        ...
                                        <ul class='slot text-white' id="slot2">
                                            <li class='numbers'>0</li>
                                            <li class='numbers'>1</li>
                                            <li class='numbers'>2</li>
                                            <li class='numbers'>3</li>
                                        ...
                                        <ul class='slot text-white' id="slot3">
                                            <li class='numbers'>0</li>
                                            <li class='numbers'>1</li>
                                            <li class='numbers'>2</li>
                                            <li class='numbers'>3</li>
                                ...
                                <div class="game-details-right h-100 d-flex align-items-center justify-content-center flex-wrap">
                                    <form class="w-100" id="game" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted mb-0 text-center"><i class="fas fa-info-circle mr-2"></i> @lang('Minimum')
