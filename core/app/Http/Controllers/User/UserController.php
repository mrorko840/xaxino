...
class UserController extends Controller {
    ...
    public function transactions(Request $request) {
        ...
        return view($this->activeTemplate . 'user.transactions', compact('pageTitle', 'transactions', 'remarks','user','widget'));
    }
    ...
    public function userDataSubmit(Request $request) {
        ...
        if ($general->rb) {
            ...
            $transaction->logo_type    = 'register_bonus';
    ...
    public function referrals() {
        ...
        return view($this->activeTemplate . 'user.referrals', compact('pageTitle', 'user', 'maxLevel','downlines'));
    }
